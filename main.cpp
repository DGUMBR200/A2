                   ...
                   int cmdShow)
{
	...
	//cSoundMgr->add("Theme", gameSounds[0]);
	//cSoundMgr->add("Shot", gameSounds[1]);
	//cSoundMgr->add("Explosion", gameSounds[2]);
	...
	LPCSTR bkgTexturesToUse[] = { "Images/RaceTrack.png", "Images/RacingStartBkg.png", "Images/RacingEndBkg.png" };
	...
	string outputMsg;
	string strMsg[] = { "Take it in turns with a friend, who's the best artist?","Drag and drop the tiles to create pictures", "Paint By Grid", "Thanks for playing!","Try again and paint something else." };
